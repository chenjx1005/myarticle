...
\end{equation}
Some of the typical visualization examples are shown in Figure \ref{fig:vis}. In  these examples, red area plays a more important role in impacting the CTR of the ad. We can see that faces, characters and main objects in ads are generally more important.
\section{Conclusions}
